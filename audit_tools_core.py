"""
منطق أدوات التدقيق والمقارنة (بدون Streamlit) — فلاتر صارمة، تحقق مدخلات/مخرجات، أسعار.
مستقل عن محرك v26 الرئيسي (`engines/mahwous_core.py`)؛ يُستورد من `mahwous_ui.audit_tools_page`.
"""
...
LOG = logging.getLogger("mahwous.audit_tools_core")
